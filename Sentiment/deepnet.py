...
# import Layer from the utils_C3.py file
from utils_C3 import Layer, load_tweets, process_tweet
import w1C3_unittest
...
- Details of process_tweet function are available in utils_C3.py file
"""

## DO NOT EDIT THIS CELL

# Import functions from the utils_C3.py file
...
"""Now import a function that processes tweets (we've provided this in the utils_C3.py file).
...
# Test your function
#w1C3_unittest.test_tweet_to_tensor(tweet_to_tensor, Vocab)
...
# Test your function
#w1C3_unittest.test_data_generator(data_generator(data_pos=train_pos, data_neg=train_neg, batch_size=4, loop=True, vocab_dict=Vocab, shuffle = False))
...
Your framework will be based on the following `Layer` class from utils_C3.py.
...
#w1C3_unittest.test_Dense(Dense)
...
#Â In order to use the layer, we need to initialize its signature
...
w1C3_unittest.test_classifier(classifier)
...
#Â Take a look on how the eval_task is inside square brackets and
#Â take that into account for you train_model implementation
...
#Â Take a look on how the eval_task is inside square brackets.
try:
    shutil.rmtree('./model_test/')
except OSError as e:
    pass

#w1C3_unittest.test_train_model(train_model(classifier(), train_task, [eval_task], 10, './model_test/'))
...
# Test your function
w1C3_unittest.test_compute_accuracy(compute_accuracy)
...
w1C3_unittest.unittest_test_model(test_model, test_generator(16, val_pos , val_neg, Vocab, loop=False, shuffle = False), model)
...
sentence = read_tweet_from_file(file_directory)
